      ...
      <div style="max-width:640px;display:flex;flex-direction:column;gap:var(--space-md)">
              ...
              <div class="purchase-code-box mb-md">
                ...
                <div class="purchase-code-options">
                  <div class="purchase-code-option">
                    ...
                    <p class="purchase-code-ussd">*800*${order.sellerTIN}#</p>
                  </div>
                  <div class="purchase-code-option">
                    ...
                    <p class="text-xs text-muted mt-sm">
                      Seller TIN: <strong style="color:var(--color-accent)">${order.sellerTIN}</strong>
                    </p>
                  </div>
                </div>
              </div>
        ...
        ${order.status === ORDER_STATUS.REJECTED ? `
          <div class="card" style="border-color:var(--color-danger)">
            ...
            ${order.rejectReason
              ? `<p class="text-muted text-sm mt-sm">Reason: ${order.rejectReason}</p>`
              : ''}
          </div>
        ` : ''}
