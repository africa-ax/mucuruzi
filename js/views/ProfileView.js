    ...
    root.innerHTML = `
      ...
      <div style="max-width:520px">
        ...
        <div class="card mb-md" style="text-align:center;padding:var(--space-xl)">
          ...
          <h2 style="font-family:var(--font-display);font-size:1.2rem;font-weight:700">${safe(user.businessName)}</h2>
          <p class="text-muted text-sm">${safe(user.email)}</p>
        ...
        <div class="card mb-md hidden" id="profile-edit-form">
          ...
          <div class="form-group">
            ...
            <input id="edit-name" type="text" class="form-input" value="${safe(user.businessName)}" />
          </div>
          <div class="form-group">
            <label class="form-label">Phone Number</label>
            <input id="edit-phone" type="tel" class="form-input" value="${safe(user.phone)}" />
          </div>
          <div class="form-group">
        ...
        <div class="card">
          ...
          <p class="text-muted text-xs mt-md text-center">
            To sign out, use the Sign Out button in the sidebar menu.
          </p>
        </div>
