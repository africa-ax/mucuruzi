...
const Router = (() => {
  ...
  const ROUTES = {
    ...
    '#product-form':  { view: 'product-form', allowedRoles: [ROLES.MANUFACTURER],                        title: 'Add Product' },
    '#raw-materials': { view: 'raw-materials', allowedRoles: [ROLES.MANUFACTURER],                        title: 'Raw Materials' },
    '#inventory':     { view: 'inventory',     allowedRoles: [ROLES.MANUFACTURER, ROLES.DISTRIBUTOR, ROLES.RETAILER, ROLES.EXPORTER], title: 'Inventory' },
  ...
  const DYNAMIC_ROUTES = [
    ...
    { pattern: /^#business\/(.+)$/,       view: 'business-profile', title: 'Business Profile' },
    { pattern: /^#product-detail\/(.+)$/, view: 'product-detail',   title: 'Compare Sellers' },
    { pattern: /^#order-form\/(.+)$/,     view: 'order-form',       title: 'Place Order' },
    { pattern: /^#credit-note\/(.+)$/,    view: 'credit-note',      title: 'Credit Note' },
  ];
